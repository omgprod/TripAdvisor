...
export default class RestaurantsRoom extends Component {
    constructor(props) {
        super(props);
        this.state = {
            restaurant: [],
    ...
    getRestaurantRoom() {
        axios.get('http://localhost:1337/restaurants/' + this.props.match.params.id, {}).then(response => {
                            ...
                            <form onSubmit={this.handleEventNotCodded}>
                                <div className="card" style={{textAlign: 'center'}}>
                                    ...
                                    <div className="card-body">
                                        <p className="card-title">{restaurant.picture}</p>
                                        ...
                                        <div style={{textAlign: 'center'}}>
                                            <div className="card-body">
                                                <p className="card-title">{restaurant.description}</p>
                                                <hr/>
                                                <p className="card-title" style={{marginTop: 10}}>get a plate
                                                    for: {restaurant.price} $</p>
                                                <hr/>
